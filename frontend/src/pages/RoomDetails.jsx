...
const RoomDetails = () => {
  ...
  return room && (
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      mx-auto mt-16 max-w-6xl border border-gray-300'>

        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>

            <div className='flex flex-col'>
                <label htmlFor='checkInDate' className='font-medium'> Check-In </label>
                <input onChange={(e) => setCheckInDate(e.target.value)} min={new Date().toISOString().split('T')[0]} type="date" id='checkInDate' placeholder='Check-In' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outine-none' required />
            </div>
            ...
            <div className='flex flex-col'>
                ...
                <input onChange={(e) => setCheckOutDate(e.target.value)} min={checkInDate} disabled={!checkInDate} type="date" id='checkOutDate' placeholder='Check-Out' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outine-none' required />
            </div>
            ...
            <div className='flex flex-col'>
                ...
                <input onChange={(e) => setGuests(e.target.value)} value={guests} type="number" id='guests' placeholder='1' className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outine-none' required />
            </div>
        ...
        max-md:mt-6 md:px-6 py-3 md:py-4 text-base cursor-pointer'>
